...
#' @note This function re-iterates the inverse of equation (1) of "PCA Gaussianization for One-Class Remote Sensing Image" by V. Laparra et al.,  \url{https://ieeexplore.ieee.org/document/5413808/}
#' @examples
#' library(RMAWGEN)
#' set.seed(1222)
#' nIterations <- 30
